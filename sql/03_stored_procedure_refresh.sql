...
BEGIN
    ...
    SELECT 
        ...
        CASE 
            WHEN abandonment_reason LIKE '%price%' OR abandonment_reason LIKE '%cost%' 
                THEN 'Price/Cost Related'
            WHEN abandonment_reason LIKE '%checkout%' OR abandonment_reason LIKE '%complicated%' 
                THEN 'Checkout Issues'
            WHEN abandonment_reason LIKE '%browsing%' THEN 'Just Browsing'
            WHEN abandonment_reason LIKE '%compare%' THEN 'Comparison Shopping'
            WHEN abandonment_reason LIKE '%security%' OR abandonment_reason LIKE '%payment%' 
                THEN 'Security/Payment Concerns'
